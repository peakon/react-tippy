...
})(this, function(__WEBPACK_EXTERNAL_MODULE_14__, __WEBPACK_EXTERNAL_MODULE_41__, __WEBPACK_EXTERNAL_MODULE_42__) {
...
function createPopperElement(id, title, settings) {
  ...
  if (html) {
    ...
    content.innerHTML = _lodash2.default.escape(title);
  }
  ...
  _createClass(Tippy, [{
    ...
    */
    ...
    value: function update(popper) {
      ...
      content.innerHTML = html ? document.getElementById(html.replace('#', '')).innerHTML : _lodash2.default.escape(el.getAttribute('title') || el.getAttribute('data-original-title'));
